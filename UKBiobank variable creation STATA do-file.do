*****Variable creation file from UK Biobank********
...
gen fruit = fruitpieces
label var fruit "pieces of fruit per day"
...
gen veg = vegpieces
label var veg "heaped tablespoons of vegetables per day"
...
*Red Meat - we will separate this back into original categories*

*Beef
gen beef = n_1369_0_0 
replace beef = 6 if n_1369_0_0 < 0 | n_1369_0_0 ==.
label var beef "how often do you eat beef"
label values beef dietL

*Pork
gen pork = n_1389_0_0 
replace pork = 6 if n_1389_0_0 < 0 | n_1389_0_0 ==.
label var pork "how often do you eat pork"
label var pork dietL

*Processed Meat*
gen processmeat =  n_1349_0_0 
replace processmeat = 6 if  n_1349_0_0 < 0
replace processmeat = 6 if  n_1349_0_0 ==.
label var processmeat "how often do you eat processed meat"
label values processmeat dietL

*Cereals to proxy*
gen cereal = n_1458_0_0
replace cereal = 0 if n_1458_0_0 < 0  | n_1458_0_0 ==.
replace cereal = 0.5 if n_1458_0_0 == -10
label var cereal "bowls of cereal consumer per week"

*Cheese*
gen cheese =  n_1408_0_0
recode cheese -3=6 -1=6 .=6
label var cheese "how often do you eat cheese"
...
label var fish "how often eat fish"
...
label define pollutionL 1 "1Q" 2 "2Q" 3 "3Q" 4 "4Q" 5 "5Q" 6 "unknown"
...
vigMETmin METmin smoking cigperday stopsmoke agestop smokingstatus ets etsmoke calcium alcohol dried fresh fruitpieces fruit salad cooked vegpieces ///
veg beef pork processmeat cereal salt sunscreen pollution jobexp skin darken hpylori aspirin ///
